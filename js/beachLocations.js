...
const destinations = [
  ...
  },
  {
    id: 15,
    title: "Yala",
    description: "Yala is a wild coastal treasure where golden beaches meet lush jungle, offering stunning seaside views and thrilling wildlife encounters on Sri Lanka’s southeastern edge.",
    image: "img/beach locations/pasikuda.jpeg",
    category: "wildlife",
    price: "$1,299",
    rating: 4.8,
  },
  {
    id: 16,
    title: "Sinharaja",
    description: "Sinharaja is a lush rainforest sanctuary with rich biodiversity, misty trails, and tranquil streams—perfect for nature lovers seeking a peaceful escape in Sri Lanka’s southwestern wilderness.",
    image: "img/beach locations/pasikuda.jpeg",
    category: "wildlife",
    price: "$1,299",
    rating: 4.8,
  },
  {
    id: 17,
    title: "Udawalawe",
    description: "Udawalawe is a scenic wildlife haven with open grasslands, serene reservoirs, and abundant elephants—ideal for a peaceful nature retreat in Sri Lanka’s southern plains.",
    image: "img/beach locations/pasikuda.jpeg",
    category: "wildlife",
    price: "$1,299",
    rating: 4.8,
  },
  {
    id: 18,
    title: "Horton Plains",
    description: "Horton Plains is a breathtaking highland plateau with misty grasslands, cloud forests, and dramatic cliff views—perfect for a serene escape into Sri Lanka’s central hill country.",
    image: "img/beach locations/pasikuda.jpeg",
    category: "wildlife",
    price: "$1,299",
    rating: 4.8,
  },
  {
    id: 19,
    title: "Wilpattu",
    description: "Wilpattu is a vast and tranquil national park with dense forests, serene lakes, and abundant wildlife—ideal for a peaceful safari adventure in Sri Lanka’s northwestern wilderness.",
    image: "img/beach locations/pasikuda.jpeg",
    category: "wildlife",
    price: "$1,299",
    rating: 4.8,
  },
  {
    ...
    description: "Minneriya National Park is a peaceful wildlife sanctuary known for its lush plains, ancient reservoir, and the majestic gathering of elephants—perfect for a serene safari in Sri Lanka’s cultural heartland.",
    image: "img/beach locations/pasikuda.jpeg",
    category: "wildlife",
    price: "$1,299",
    rating: 4.8,
  },
  {
    ...
    description: "The Temple of the Tooth in Kandy is a sacred and serene cultural site, home to a revered relic of the Buddha—offering a peaceful spiritual experience in Sri Lanka’s historic hill capital.",
    image: "img/beach locations/pasikuda.jpeg",
    category: "religious",
    price: "$1,299",
    rating: 4.8,
  ...
  {
    id: 22,
    title: "Sri Maha Bodhi, Anuradhapura",
    description: "Sri Maha Bodhi in Anuradhapura is a sacred and tranquil pilgrimage site, home to the world’s oldest living tree with a recorded history—offering a serene spiritual journey in Sri Lanka’s ancient capital.",
    image: "img/beach locations/pasikuda.jpeg",
    category: "religious",
    price: "$1,299",
    rating: 4.8,
  ...
  {
    id: 23,
    title: "Kelaniya Raja Maha Viharaya",
    description: "Kelaniya Raja Maha Viharaya is a revered and peaceful temple adorned with stunning murals and rich history—offering a serene spiritual experience near Colombo on Sri Lanka’s western plains.",
    image: "img/beach locations/pasikuda.jpeg",
    category: "religious",
    price: "$1,299",
    rating: 4.8,
  ...
  {
    id: 24,
    title: "Seetha Amman Temple, Nuwara Eliya",
    description: "Seetha Amman Temple in Nuwara Eliya is a serene and mystical shrine nestled among lush hills and flowing streams—offering a peaceful spiritual retreat linked to the Ramayana legend in Sri Lanka’s central highlands.",
    image: "img/beach locations/pasikuda.jpeg",
    category: "religious",
    price: "$1,299",
    rating: 4.8,
  ...
  {
    id: 25,
    title: "Dutch Reformed Church, Galle",
    description: "The Dutch Reformed Church in Galle is a historic and tranquil landmark with colonial architecture—offering a quiet glimpse into Sri Lanka’s rich Dutch heritage within the charming Galle Fort.",
    image: "img/beach locations/pasikuda.jpeg",
    category: "religious",
    price: "$1,299",
    rating: 4.8,
